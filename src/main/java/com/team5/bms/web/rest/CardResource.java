...
/**
 * REST controller for managing {@link com.team5.bms.model.Card}.
 *
 * @author
 */
@RestController
...
public class CardResource {
    ...
    public ResponseEntity<Card> partialUpdateCard(@PathVariable(value = "id", required = false) final Long id, @NotNull @RequestBody Card card) throws URISyntaxException {
